...
##############CHECK##############
setwd("/Users/adityanatu/Library/Mobile Documents/com~apple~CloudDocs/Project_2023/Juliet_Data_Analysis/EV_RNASeq/4.microRNAseq_EVs_RAW counts/IL10/")
getwd()
...
##############CHECK##############
cleanDat <- read.csv("IL10_microRNAseq_EVs_RAW counts.csv", header = TRUE, row.names = 1)
...
numericMeta <- read.csv("IL10_microRNAseq_EVs_RAW_Traits.csv", header = TRUE, row.names = 1)
