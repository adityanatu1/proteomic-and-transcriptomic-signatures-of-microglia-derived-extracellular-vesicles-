...
##############CHECK##############
setwd("/Users/adityanatu/Library/Mobile Documents/com~apple~CloudDocs/Project_2023/Juliet_Data_Analysis/EV_Cell_RNASeq/4.microRNAseq_EVs_RAW counts/LPS")
getwd()
...
##############CHECK##############
cleanDat <- read.csv("LPS_microRNAseq_EVs_RAW counts.csv", header = TRUE, row.names = 1)
...
numericMeta <- read.csv("LPS_microRNAseq_EVs_RAW_Traits.csv", header = TRUE, row.names = 1)
