...
##############CHECK##############
setwd("/Users/adityanatu/Library/Mobile Documents/com~apple~CloudDocs/Project_2023/Juliet_Data_Analysis/EV_RNASeq/3.microRNAseq_Cells_RAW counts/All PCA/")
getwd()
...
##############CHECK##############
cleanDat <- read.csv("microRNAseq_Cells_RAW_Counts.csv", header = TRUE, row.names = 1)
...
numericMeta <- read.csv("mRNAseq_EVs_RAW_Traits.csv", header = TRUE, row.names = 1)
