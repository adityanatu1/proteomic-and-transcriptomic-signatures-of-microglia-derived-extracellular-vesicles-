...
##############CHECK##############
setwd("/Users/adityanatu/Library/Mobile Documents/com~apple~CloudDocs/Project_2023/Juliet_Data_Analysis/EV_Cell_RNASeq/3.microRNAseq_Cells_RAW counts/LPS")
getwd()
...
##############CHECK##############
cleanDat <- read.csv("LPS_microRNAseq_Cells_RAW_Counts.csv", header = TRUE, row.names = 1)
...
numericMeta <- read.csv("LPS_microRNAseq_Cells_RAW_Trait.csv", header = TRUE, row.names = 1)
