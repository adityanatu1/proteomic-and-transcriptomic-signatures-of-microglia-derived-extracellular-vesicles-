...
library(M3C)
setwd("/Users/adityanatu/Library/Mobile Documents/com~apple~CloudDocs/Project_2023/Juliet_Data_Analysis/BV2_Juliet_EV_Proteome_Analysis/New_Norm_Data_Exosome")
getwd()
...
#this code requires Grouping variable as created + cleanDat which is your input data for abundances
#The p value is calculated using ANOVA Tukey P value for multiple pairwise comparison - should u need the ttest equivalent p value which ignores multiple test correction - then you must subset your cleandat w/ only 2 groups

 

#### PCA With DeX proteins: coming from toplot!
#Sanity check and just doing a rowmatch leads to 22 unique across all comparisons!
